...
const { pubComment, replyComment, deleteComment, commentList } = require('./middleware')

const commentRouter = new Router({prefix: '/comment'})

commentRouter.post('/', verifyToken, pubComment) // 对动态发表评论
commentRouter.post('/:commentId', verifyToken, replyComment) // 对评论进行回复
